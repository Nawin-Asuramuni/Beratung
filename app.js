  ...
  document.getElementById('pn_confirm_btn').onclick = async () => {
    ...
    if (slot.telefon || slot.email) {
      ...
      if (sendNotify && contactObj.email) {
        ...
        // withIcs:false sorgt dafür, dass sendConfirmationEmail() korrekt das
        // Benachrichtigungs-Template (notifySubject/emailNotifyText) nutzt
        // statt fälschlich die Bestätigungs-Vorlage zu verschicken.
